...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-end justify-start overflow-hidden bg-gradient-to-br from-background via-background to-secondary/20">
      ...
      <div className="relative z-30 container mx-auto px-6 lg:px-8 pb-20">
        <div className="max-w-3xl">
          ...
          >
            Yield-Bearing Stablecoin for Everyday Nigerians. Safe P2P trading with guaranteed liquidity and low fees. Mobile wallet coming soon.
          </p>
